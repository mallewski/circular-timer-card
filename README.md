...
| rotation | string | optional | clockwise | Direction the timer empties. Available options are "clockwise" or "anticlockwise". Applies to both circle and minimal layouts. |
